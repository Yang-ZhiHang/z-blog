                ...
                item: [
                    {
                        ...
                        description: '一个 JavaScript 框架，采用组件化开发方式，具有双向数据绑定、虚拟 DOM 等特性。Vue 的单文件组件（SFC）特性使得 HTML、CSS、JS 均能在一个文件中编写。'
                    },
                    {
                        title: 'TypeScript',
                    ...
                    },
                    {
                        ...
                        description: '一种 Python 框架，一般用于构建 Web 应用的后端。相比于 Flask 提供了更高的性能、易用的 API。'
                    },
                    {
                        title: 'PostgreSQL',
