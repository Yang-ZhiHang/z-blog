...
<template>
    <article 
        ref="cardRef" 
        class="relative flex-col border-4 border-black rounded-[1.5rem_1.5rem_0_1.5rem] overflow-hidden cursor-pointer transition-all duration-100 opacity-0 animate-[fade-in_0.1s_ease-in-out_forwards] hover:border-[var(--flicker-color-2)]" 
